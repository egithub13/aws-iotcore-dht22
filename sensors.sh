...
python3 sensors.py --endpoint a3rzefpfvv2j7j-ats.iot.us-east-1.amazonaws.com --ca_file root-CA.crt --cert Pi3aPlus.cert.pem --key Pi3aPlus.private.key --client_id basicPubSub --topic $topic --count $count
